...
def eigenpro_solve(X_train, y_train, X_test, y_test, c, L, steps, M):
    ...
    return model.weight.cpu().numpy(), best_acc, best_ep_iter, model.eigenvectors_data, acc
...
#     y_test = convert_one_hot(y_test, c)
    ...
    for i in range(iters):
        sol, old_test_acc, s_ep_iter, eigenvectors_data, _ = eigenpro_solve(X_train, y_train,
                                                         X_test, y_test,
                                                         c, L, ep_iter,
                                                         torch.from_numpy(M))
    ...
    return best_acc, best_iter, best_M, best_ep_iter, eigenvectors_data
